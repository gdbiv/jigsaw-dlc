...
public class UniversePigEntity extends Monster {
	...
	public UniversePigEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JigsawPonosDlcModEntities.UNIVERSE_PIG.get(), world);
	}

	public UniversePigEntity(EntityType<UniversePigEntity> type, Level world) {
		super(type, world);
		xpReward = 32767;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(JigsawPonosDlcModItems.WAND_OF_MASS_DESTRUCTION.get()));
	}
	...
	public void baseTick() {
		super.baseTick();
		UniversePigOnEntityTickUpdateProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	}
